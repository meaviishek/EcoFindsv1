...
const Page = () => {
    ...
    const handleSignup = async () => {
        if (validateSignup()) {
            ...
            //     console.log("done", res.data.user)
            //     router.push('/profile')
            // }
        }
    }
        ...
        <div className='h-[100vh] flex justify-center items-center'>
            <div className='h-[80vh] bg-white border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2'>
                    ...
                    <div className="flex items-center justify-center w-full">
                        <Tabs className='w-3/4' defaultValue='login'>
                            ...
                            <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                                ...
                                <Button className="rounded-full p-6" onClick={handleLogin}>Login
                            ...
                            <TabsContent className="flex flex-col gap-5 " value="signup">
                                ...
                                <Button className="rounded-full p-6" onClick={handleSignup}>Sign Up
                ...
                <div className='hidden xl:flex justify-center items-center'>
                    <img src="https://www.go.ooo/img/bg-img/Login.jpg" className='h-[500px]' alt="Picture of the author" />
                </div>
            </div>
